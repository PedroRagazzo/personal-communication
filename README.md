...
FASE 11 (Electron) está em andamento — próxima fatia natural é deafen ou editar/apagar/reagir mensagem (ambas pequenas, reaproveitam infraestrutura já pronta), depois criar servidor/canal no cliente e Go Live. Outras direções em aberto, a decidir com quem está lendo isto:
