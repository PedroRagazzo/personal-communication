...
FASE 11 (Electron) está em andamento — próxima fatia natural é criar canal no cliente (não servidor — fora de escopo, ver `docs/roadmap.md`), depois Go Live. Amigos/DM e FASE 10 (arquivos avançado) saem do planejado — servidor único, uso privado por ~20 pessoas, nunca público. Ainda em aberto:
